...
const questions = [
  ...
  },
  {
    ...
    options: ["Jordan", "Egypt", "Morocco", "Turkey"],
  ...
  },
  {
    ...
    options: ["Germany", "Argentina", "Spain", "Brazil"],
  ...
  },
  {
    ...
    options: ["Copper", "Iron", "Zinc", "Titanium"],
    correctAnswer: "Iron",
    category: "Science",
    difficulty: "easy",
    points: 95,
  },
  {
    ...
    options: ["Samuel Beckett", "Arthur Miller", "Tennessee Williams", "Harold Pinter"],
  ...
  {
    question: "In computing, what does 'JSON' stand for?",
    options: [
      "Java Source Object Notation",
      "JavaScript Object Notation",
      "Java Serialized Object Network",
      "Joint Scripted Object Namespace",
    ],
  ...
  {
    question: "Which Greek god is known as the messenger?",
